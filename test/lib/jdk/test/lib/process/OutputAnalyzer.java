...
public final class OutputAnalyzer {
     ...
     */
    public void shouldContain(String[] expectedStrings, boolean verbose) {
    ...
    public void shouldContain(String... expectedStrings) {
        shouldContain(expectedStrings, true);
    }
